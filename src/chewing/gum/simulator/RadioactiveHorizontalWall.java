...
public class RadioactiveHorizontalWall extends GameObject{
    ...
    public RadioactiveHorizontalWall(int x, int y, ID id, Handler handler){
        super(x,y,id);
    ...
    public Rectangle getBounds(){
        ...
        return new Rectangle((int)x,(int)y,50,10);
    }
