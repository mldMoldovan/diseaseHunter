...
public class AdventureShop extends MouseAdapter{
    Handler handler;
    ...
    public AdventureShop(ChewingGumSimulator Game,Handler handler){
        this.Game = Game;
    ...
    public void mousePressed(MouseEvent e){
        ...
        //REFILL AMMO
        if(mouseOver(mx,my,10,80,200,60) && Game.gameState == ChewingGumSimulator.STATE.AdventureShop){
            if(HUD.COINS>=50){
                if(HUD.AMMO<100){
                HUD.COINS-=50;
                HUD.AMMO=100;
        ...
        //REFILL BLADDER
        if(mouseOver(mx,my,10,150,200,60) && Game.gameState == ChewingGumSimulator.STATE.AdventureShop){
            if(HUD.COINS>=75){
                if(HUD.BLADDER<100){
                HUD.COINS-=75;
                HUD.BLADDER=100;
        ...
        //SHIELD BOOST
        if(mouseOver(mx,my,220,10,200,60) && Game.gameState == ChewingGumSimulator.STATE.AdventureShop){
            if(HUD.COINS>=200){
                HUD.COINS-=200;
        ...
        //SPEED BOOST
        if(mouseOver(mx,my,220,80,200,60) && Game.gameState == ChewingGumSimulator.STATE.AdventureShop){
            if(HUD.COINS>=300){
                HUD.COINS-=300;
        ...
        //DAMAGE BOOST
        if(mouseOver(mx,my,220,150,200,60) && Game.gameState == ChewingGumSimulator.STATE.AdventureShop){
            if(HUD.COINS>=250){
                HUD.COINS-=250;
        ...
        //NANO EMP
        if(mouseOver(mx,my,430,10,200,60) && Game.gameState == ChewingGumSimulator.STATE.AdventureShop){
            if(HUD.COINS>=150){
                if(HUD.EMPCount<10){
                HUD.COINS-=150;
                HUD.EMPCount++;
        ...
        //UNIVERSAL NUKE
        if(mouseOver(mx,my,430,80,200,60) && Game.gameState == ChewingGumSimulator.STATE.AdventureShop){
            if(HUD.COINS>=1000){
        ...
        //ATOMIC FISSION
        if(mouseOver(mx,my,430,150,200,60) && Game.gameState == ChewingGumSimulator.STATE.AdventureShop){
            if(HUD.COINS>=150){
                if(HUD.ATOMS<25){
                HUD.COINS-=150;
                HUD.ATOMS++;
        ...
        //BACK BUTTON
        if(mouseOver(mx,my,220,290,200,60) && Game.gameState == ChewingGumSimulator.STATE.AdventureShop){
