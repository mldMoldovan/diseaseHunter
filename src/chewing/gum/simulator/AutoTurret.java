...
public class AutoTurret extends GameObject{
    ...
    private double autoTurretLife = 40;
    private GameObject player;
    private boolean Placed=false;
    
    
    public AutoTurret(int x, int y, ID id, Handler handler){
        super(x,y,id);
    ...
    public void tick(){
        ...
        if(lifeTimer%20==0 && objects<21){
            if(autoTurretLife>0){
            handler.addObject(new Antibody((int)x+10,(int)y+10,ID.Antibody,handler));
            objects++;}
        }
