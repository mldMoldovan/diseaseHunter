...
public class BossSevenSucker extends GameObject{
    
    private Handler handler;
    private Random r = new Random();
    private int TimeSucks=80;
    private int TimeSucks2=50;
    private float Sucker7Health = 100;
    private float blingreenvalue = 254f;
    private Color col=Color.black;
    
    public BossSevenSucker(int x, int y, ID id, Handler handler){
        super(x,y,id);
    ...
    public void tick(){
        x+=velX;
        y+=velY;
        Sucker7Health = ChewingGumSimulator.clamp(Sucker7Health,0,100);
        blingreenvalue = Sucker7Health;
        ...
        if(TimeSucks2 <= 0) {
            ...
            collision();
            if(Sucker7Health==0)
        {   ChewingGumSimulator.trophiesStatus[16]=true;
    ...
    public void render(Graphics g){
        ...
        g.fillRect((int)x+5, (int)y-20,(int) Sucker7Health *2/10, 3);
        g.setColor(Color.white);
        g.drawRect((int)x+5, (int)y-20,(int) Sucker7Health *2/10, 3);
