...
public class BossEightSucker extends GameObject{
    
    private Handler handler;
    private Random r = new Random();
    private int TimeSucks=80;
    private int TimeSucks2=50;
    private float Sucker8Health = 100;
    private float blingreenvalue = 254f;
    private Color col=Color.black;
    
    public BossEightSucker(int x, int y, ID id, Handler handler){
        super(x,y,id);
    ...
    public void tick(){
        x+=velX;
        y+=velY;
        Sucker8Health = ChewingGumSimulator.clamp(Sucker8Health,0,100);
        blingreenvalue = Sucker8Health;
        ...
        if(TimeSucks2 <= 0) {
            ...
            collision();
            if(Sucker8Health==0)
        {   ChewingGumSimulator.trophiesStatus[17]=true;
    ...
    public void render(Graphics g){
        ...
        g.fillRect((int)x+5, (int)y-20,(int) Sucker8Health *2/10, 3);
        g.setColor(Color.white);
        g.drawRect((int)x+5, (int)y-20,(int) Sucker8Health *2/10, 3);
