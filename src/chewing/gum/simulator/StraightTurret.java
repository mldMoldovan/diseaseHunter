...
public class StraightTurret extends GameObject{
    ...
    private double straightTurretLife=40;
    ...
    public StraightTurret(int x, int y, ID id, Handler handler){
        super(x,y,id);
    ...
    public void setLife(double straightTurretLife){
        this.straightTurretLife=straightTurretLife;
        
    }
    
    public double getLife(){
        return straightTurretLife;
    }
    ...
    public void tick(){
        ...
        if(lifeTimer%20==0){
            if(straightTurretLife>0){
            handler.addObject(new StraightParticle((int)x+10,(int)y+10,ID.StraightParticle,handler));
            }
            }
