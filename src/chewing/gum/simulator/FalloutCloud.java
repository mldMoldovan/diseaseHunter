...
public class FalloutCloud extends GameObject{
    
    private Handler handler;
    
    Random r = new Random();
    
    private int snowtimer=50;
    ...
    public FalloutCloud(float x, float y, ID id, Handler handler){
        super(x,y,id);
    ...
    public void tick(){
        ...
        if(snowtimer2 <= 0) {
            ...
            if(spawn == 0) 
                handler.addObject(new FalloutDrop((int)x+32,(int) y+15, ID.RainDrop,handler));
    ...
    public void render(Graphics g){
        ...
        g.fillRoundRect((int)x,(int)y,50,30,20,35);
