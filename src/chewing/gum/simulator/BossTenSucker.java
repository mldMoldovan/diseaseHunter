...
public class BossTenSucker extends GameObject{
    
    private Handler handler;
    private Random r = new Random();
    private int TimeSucks=80;
    private int TimeSucks2=50;
    private float Sucker10Health = 100;
    private float blingreenvalue = 254f;
    private Color col=Color.black;
    
    public BossTenSucker(int x, int y, ID id, Handler handler){
        super(x,y,id);
    ...
    public void tick(){
        x+=velX;
        y+=velY;
        Sucker10Health = ChewingGumSimulator.clamp(Sucker10Health,0,100);
        blingreenvalue = Sucker10Health;
        ...
        if(TimeSucks2 <= 0) {
            ...
            collision();
            if(Sucker10Health==0)
        {   ChewingGumSimulator.trophiesStatus[19]=true;
    ...
    public void render(Graphics g){
        ...
        g.fillRect((int)x+5, (int)y-20,(int) Sucker10Health *2/10, 3);
        g.setColor(Color.white);
        g.drawRect((int)x+5, (int)y-20,(int) Sucker10Health *2/10, 3);
