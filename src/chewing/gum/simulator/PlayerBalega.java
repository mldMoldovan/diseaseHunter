...
public class PlayerBalega extends GameObject{
    ...
    public PlayerBalega(int x, int y, ID id, Handler handler){
        super(x,y,id);
    ...
    public void render(Graphics g){
        g.setColor(col);
            ...
            g.fillRect((int)x+5,(int)y+26,13,9);
            g.fillRect((int)x+2,(int)y+35,19,9);
    }
